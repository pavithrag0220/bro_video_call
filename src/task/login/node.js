...
export class Node extends Component {
    ...
    callApi = async () => {
        ...
        var callUserapi = await axios.post('http://localhost:8080/users/',postObject)
            .then((res => {
                console.log('data', res.data.allUsers)
                this.setState({
                    userList: res.data.allUsers,
                    allowAccess:res.data.access
                })
            }))
    ...
    handleSubmit = async (e) => {
        ...
        var addUser = await axios.post('http://localhost:8080/users', userInfo)
